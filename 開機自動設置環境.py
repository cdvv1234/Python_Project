...
# Step 1: 創建資料夾
def create_folders(selected_groups):
...
folder_groups = {
    ...
    "3. - 14、17、19、20": ["14", "17", "19", "20"],
    "4. - 22、27、28、32": ["22", "27", "28", "32"],
    "5. - 33、34、35、36": ["33", "34", "35", "36"],
    "6.- 37、ICT02、TG1、TG2": ["37", "ICT02", "TG1", "TG2"]
}
...
def create_ui():
    ...
    def on_create_folders():
        if selected_groups:
            create_folders(selected_groups)
        else:
